...
const launch = async (args, { appPath, env, cwd, rendererInterval, rendererTimeout } = {}) => {
  const { start: startElectron, stop: stopElectron, getLogs } = electron(args, { appPath, env, cwd });
